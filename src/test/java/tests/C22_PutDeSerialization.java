...
public class C22_PutDeSerialization extends JsonPlaceHolderBaseUrl {
    ...
    */
    ...
    public void put01(){
        ...
        // 4- Assertion
        HashMap<String,Object>resMap = response.as(HashMap.class); // expected data'miz map bize donen
        // responce ise json formatinda o yuzden responce map formatina cevirdik.

        Assert.assertEquals(testDataJsonPlaceHolder.successfulStatusCode,response.getStatusCode());
